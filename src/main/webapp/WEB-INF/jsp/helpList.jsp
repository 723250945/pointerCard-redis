...
<div id="homebody">
    <div id="newleft">
            <ul>
                <li><a href="${pageContext.request.contextPath}/static/tohelfList/1" >${guideList[0].type}</a></li>
                <li><a href="${pageContext.request.contextPath}/static/tohelfList/2" >${guaranteeList[0].type}</a></li>
                <li><a href="${pageContext.request.contextPath}/static/tohelfList/3" >${membeList[0].type}</a></li>
                <li><a href="${pageContext.request.contextPath}/static/tohelfList/4" >${afterSalList[0].type}</a></li>
            </ul>
        </div>
         <div id="newsRight">
            <c:forEach var="news" items="${helpList}">
                <p><a class="newInfo" href="${pageContext.request.contextPath}/static/tohelpView/${nid}/${news.nId}">${news.title}...</a></p>
            </c:forEach>
    </div>
</div>
<script src="${pageContext.request.contextPath}/static/rootWeb/js/jquery-1.8.3.min.js"></script>
