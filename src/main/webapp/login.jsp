...
<header  class="header_middle">
    ...
    <div class="login_header_right"><a href="${pageContext.request.contextPath}/static/index" class="blue">首页</a> | <a href="${pageContext.request.contextPath}/toProduct" class="blue">商品展示页</a>  | <a href="${pageContext.request.contextPath}/toShop" class="blue">购物车</a> | <a href="${pageContext.request.contextPath}/static/toregist" class="blue">注册</a></div>
</header>
<div id="main">
...
<input type="hidden" id="logininfo"  value="${e}"/>
</body>
<script src="${pageContext.request.contextPath}/static/rootWeb/js/jquery-1.8.3.min.js"></script>
<script src="${Context.request.contextPath}/static/rootWeb/js/login.js"></script>
<script src="${Context.request.contextPath}/static/rootWeb/js/loginInfo.js"></script>
